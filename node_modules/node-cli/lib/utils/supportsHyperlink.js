...
const supportsHyperlink = (stream) => {
    const { env } = process;
    if (!env)
        return;
    ...
    if (hasFlag_1.hasFlag('no-hyperlink') || hasFlag_1.hasFlag('no-hyperlinks') || hasFlag_1.hasFlag('hyperlink=false') || hasFlag_1.hasFlag('hyperlink=never')) {
        return false;
    }
    if (hasFlag_1.hasFlag('hyperlink=true') || hasFlag_1.hasFlag('hyperlink=always')) {
        return true;
    }
