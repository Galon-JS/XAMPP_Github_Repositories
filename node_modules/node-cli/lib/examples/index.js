...
const main = async () => {
    ...
    if (typeof index !== 'undefined') {
        ...
        switch (options[index]) {
            ...
            case 'Multi Select':
                ...
                break;
            case 'Messages':
                messages_1.step('step');
                messages_1.warn('warn');
                messages_1.success('success', null);
                messages_1.error('error', false);
                messages_1.info('info');
                messages_1.question('question', null);
                messages_1.comment('comment');
                break;
            case 'Tabs':
    ...
    messages_1.comment('Ctrl+C to go back');
};
/**
 * Hide Cursor
 */
